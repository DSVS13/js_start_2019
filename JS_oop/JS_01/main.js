...
// базовый конструктор «Транспортное средство» с общими для всех транспортных средств свойствами 
// и методами (на ваше усмотрение);
// дочерние конструкторы: автомобиль, самолет, корабль, которые наследуют общие свойства 
// и методы от родительского;
// продемонстрировать, как дочерние сущности могут переопределять родительские свойства 
// и методы в соответствии со своим собственным поведением

// var totalUnits = prompt('Всего едениц техники');
// var repairsUnits = prompt('Всего едениц техники в ремонте');
// var operatedUnits = prompt('Всего едениц техники в работе');

// var vehicles = new Vehicles(13, 3, 9);
// console.log(vehicles);
// console.log(vehicles.getNotUsesUnits());
// var aircraftUnits = new Aircraft(3, 1, 2, 30);
// console.log(aircraftUnits);
// console.log(aircraftUnits.getNotUsesUnits());
// var carUnits = new Car(7, 2, 4, 20);
// console.log(carUnits);
// console.log(carUnits.getNotUsesUnits());
// var shipUnits = new Ships(2, 0, 2, 10);
// console.log(shipUnits);
// console.log(shipUnits.getNotUsesUnits());
